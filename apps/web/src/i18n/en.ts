...
export const en: Record<keyof typeof es, string> = {
  ...
  // ── Carta de extras ──
  'comun.extras': 'Extras',
  'ext.titulo': 'Extras menu',
  'ext.pista':
    'What your clients can add to any service when they book. One menu, the same for every service.',
  'ext.anadir': 'Add extra',
  'ext.nuevo': 'New extra',
  'ext.nombre': 'Name',
  'ext.nombreEjemplo': 'e.g. Hydrating treatment',
  'ext.precio': 'Price',
  'ext.precioPista': 'In euros. Added to the service price.',
  'ext.precioEjemplo': '12.00',
  'ext.duracion': 'Extra time',
  'ext.duracionPista': 'In minutes. 0 if it doesn’t make the appointment longer.',
  'ext.descripcion': 'Description',
  'ext.descripcionEjemplo': 'e.g. 10-minute mask after washing',
  'ext.foto': 'Photo',
  'ext.subirFoto': 'Upload photo',
  'ext.cambiarFoto': 'Change',
  'ext.quitarFoto': 'Remove',
  'ext.errFoto': 'That photo couldn’t be read. Try another one in JPG or PNG.',
  'ext.errNombre': 'Enter a name at least 2 characters long.',
  'ext.errPrecio': 'Enter a valid price (0 if it’s free).',
  'ext.errDuracion': 'Enter the minutes it adds (0 if it doesn’t make the appointment longer).',
  'ext.guardar': 'Add to menu',
  'ext.guardarCambios': 'Save changes',
  'ext.cancelar': 'Cancel',
  'ext.editar': 'Edit',
  'ext.ocultar': 'Hide',
  'ext.mostrar': 'Show',
  'ext.oculto': 'Hidden',
  'ext.quitar': 'Remove',
  'ext.quitarPregunta': 'Remove “{nombre}”?',
  'ext.siQuitar': 'Yes, remove',
  'ext.vacio': 'No extras yet',
  'ext.vacioPista':
