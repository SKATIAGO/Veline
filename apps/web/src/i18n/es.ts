...
export const es = {
  ...
  // ── Carta de extras ──
  'comun.extras': 'Extras',
  'ext.titulo': 'Carta de extras',
  'ext.pista':
    'Lo que tus clientes pueden añadir a cualquier servicio al reservar. Es una sola carta, igual para todos los servicios.',
  'ext.anadir': 'Añadir extra',
  'ext.nuevo': 'Nuevo extra',
  'ext.nombre': 'Nombre',
  'ext.nombreEjemplo': 'Ej. Tratamiento hidratante',
  'ext.precio': 'Precio',
  'ext.precioPista': 'En euros. Se suma al del servicio.',
  'ext.precioEjemplo': '12,00',
  'ext.duracion': 'Tiempo que añade',
  'ext.duracionPista': 'En minutos. 0 si no alarga la cita.',
  'ext.descripcion': 'Descripción',
  'ext.descripcionEjemplo': 'Ej. Mascarilla de 10 minutos después del lavado',
  'ext.foto': 'Foto',
  'ext.subirFoto': 'Subir foto',
  'ext.cambiarFoto': 'Cambiar',
  'ext.quitarFoto': 'Quitar',
  'ext.errFoto': 'No se ha podido leer esa foto. Prueba con otra en JPG o PNG.',
  'ext.errNombre': 'Escribe un nombre de al menos 2 letras.',
  'ext.errPrecio': 'Pon un precio válido (0 si es gratis).',
  'ext.errDuracion': 'Pon los minutos que añade (0 si no alarga la cita).',
  'ext.guardar': 'Añadir a la carta',
  'ext.guardarCambios': 'Guardar cambios',
  'ext.cancelar': 'Cancelar',
  'ext.editar': 'Editar',
  'ext.ocultar': 'Ocultar',
  'ext.mostrar': 'Mostrar',
  'ext.oculto': 'Oculto',
  'ext.quitar': 'Quitar',
  'ext.quitarPregunta': '¿Quitar «{nombre}»?',
