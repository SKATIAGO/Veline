        ...
        {PLANES.map((plan, i) => (
          ...
          >
            ...
            >
              ...
              <div className="mt-1.5 mb-6 text-body text-subtle">{plan.tagline}</div>
          ...
          {EXTRAS.map((extra, i) => (
            <Reveal key={extra.name} delay={i * 90} variant={i % 2 === 0 ? 'left' : 'right'}>
              <Card className="lift flex h-full flex-col p-7">
                ...
                <p className="mt-4 text-meta text-subtle">{extra.note}</p>
              </Card>
            </Reveal>
          ))}
        </div>
            ...
            <Reveal key={i} delay={i * 110} variant="zoom">
              <div className="lift flex min-h-[200px] flex-col justify-between rounded-xl border border-dashed border-ph-border bg-ph-bg/40 p-6">
                ...
                <div className="mt-6 flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-body font-semibold text-ph-text">Nombre y negocio</div>
                    <div className="text-meta text-ph-text/80">Sector · Ciudad</div>
                  </div>
                </div>
              </div>
            </Reveal>
